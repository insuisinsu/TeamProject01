...
insert into theme values ( 1, '댄스' );
insert into theme values ( 2, '발라드' );
insert into theme values ( 3, 'POP' );
insert into theme values ( 4, '랩/힙합' );
insert into theme values ( 5, '인디' );
insert into theme values ( 6, '트로트' );
insert into theme values ( 7, 'RB' );
